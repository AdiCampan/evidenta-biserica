          ...
          <Col>
            <InputGroup size="sm" className="mb-3">
              ...
              <Form.Control aria-label="Small" aria-describedby="inputGroup-sizing-sm"
                onChange={(event) => setPereche(event.target.value)} value={pereche} />
            </InputGroup>
          </Col>
          <Col>
            <InputGroup size="sm" className="mb-3">
              ...
              <Form.Control aria-label="Small" aria-describedby="inputGroup-sizing-sm"
                value={servCivil}
                onChange={(event) => setServCivil(event.target.value)} />
            </InputGroup>
          </Col>
        ...
        <Row>
          <Col>
            <InputGroup size="sm" className="mb-3">
              ...
              <Form.Control aria-label="Small" aria-describedby="inputGroup-sizing-sm"
                onChange={(event) => setServRel(event.target.value)} value={servRel} />
            </InputGroup>
          </Col>
          <Col>
            <InputGroup size="sm" className="mb-3">
